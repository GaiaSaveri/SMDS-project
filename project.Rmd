...
I am not being able to understand this error number. Is good or bad? I will research tomorrow. I know the one in the left is the standard error and the one in the right is the adjusted error. 
...
So, I thought that with the predictive accuracy we would be able to choose between the poisson and the negative binomial. So this didn't happen. They perform equally, both when we predict with the 95% confidence interval in the training data and in the leave-one-out cross validation. So what do we do to choose one over the other? what arguments to use?
