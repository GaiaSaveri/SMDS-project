...
**ANGELA:** Seeing [Wikipedia](https://en.wikipedia.org/wiki/Natural_regions_of_Colombia) I think that the Orinoquía Region (Meta, Arauca, Casanare and Vichada Departments) is in the center, so I would add also **Arauca**, **Casanare** and **Vichada**.
