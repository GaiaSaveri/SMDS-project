...
with $i = 1,\dots,134$, being $357$ the number of rows of our dataset, and $y_i$ represents the number of cases.
...
```{r fix data, echo=FALSE, eval=FALSE, warning=FALSE}
cases_dep<-cases_dep[order(cases_dep$Department),]
```
...
## Posterior predictive check - Poisson cumulative
...
## Residual check - Poisson cumulative number of cases
...
## Poisson model for the number of new cases
...
## Negative Binomial model - cumulative number of cases
...
## Residual check - Negative binomial cumulative
