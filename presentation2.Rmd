...
poisson1.pred <- predict(poisson1, newdata = cases[23:25, ])
...
poisson2.pred <- predict(poisson2, newdata = data1[23:25, ])
...
poisson3.pred <- predict(poisson3, newdata = data1[23:25, ])
...
poisson4.pred <- predict(poisson4, newdata = data1[23:25, ])
...
poisson4bis.pred <- predict(poisson4bis, newdata = data1[23:25, ])
...
poisson5.pred <- predict(poisson5, newdata = data1[23:25, ])
...
par(mfrow=c(2,2))
plot(poisson6)
poisson6.pred <- predict(poisson6, newdata = data1[23:25, ])
...
attach(data1)
conf.df_pois <- predict.confidence(poisson4, newdata = as.data.frame(cbind(data1$`Elapsed time`, data1$`Cumulative cases`)))
...
nb1.pred <- predict(nb1, newdata = data1[23:25, ])
...
par(mfrow=c(2,2))
plot(nb2)
nb2.pred <- predict(nb2, newdata = data1[23:25, ])
...
par(mfrow=c(2,2))
plot(nb3)
nb3.pred <- predict(nb3, newdata = data1[23:25, ])
...
par(mfrow=c(2,2))
plot(nb4)
nb4.pred <- predict(nb4, newdata = data1[23:25, ])
...
nb5.pred <- predict(nb5, newdata = data1[23:25, ])
