...
paste("MSE:", sqrt(mean((poisson1.pred - cases$`Cumulative cases`[23:25])^2)))
...
paste("MSE:", sqrt(mean((poisson2.pred - data1$`Cumulative cases`[23:25])^2)))
...
paste("MSE:", sqrt(mean((poisson3.pred - data1$`Cumulative cases`[23:25])^2)))
...
paste("MSE:", sqrt(mean((poisson4.pred - data1$`Cumulative cases`[23:25])^2)))
...
paste("MSE:", sqrt(mean((poisson4bis.pred - data1$`New cases/day`[23:25])^2)))
#paste("MSE:", mean(poisson4$residuals^2))
...
paste("MSE:", sqrt(mean((poisson5.pred - data1$`Cumulative cases`[23:25])^2)))
...
paste("MSE:", sqrt(mean((poisson6.pred - data1$`Cumulative cases`[23:25])^2)))
...
paste("MSE:", sqrt(mean((nb1.pred - data1$`Cumulative cases`[23:25])^2)))
...
paste("MSE:", sqrt(mean((nb2.pred - data1$`Cumulative cases`[23:25])^2)))
...
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  ...
  geom_line(aes(x = `Elapsed time`, y = conf.df_nb$fit[1:22]),
              ...
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = conf.df_nb$fit[22:25]),
              data = data1[22:25, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `Cumulative cases`)) +
