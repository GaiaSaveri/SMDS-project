...
paste("RMSE:", sqrt(mean((poisson1.pred - cases$`Cumulative cases`[120:126])^2)))
#paste("MSE:", mean(poisson1$residuals^2))
#print(sprintf("MSE: %0.2f", sum(poisson1$residuals^2)/poisson1$df.residual))
#print(sprintf("MSE: %0.2f", anova(poisson1)['Residuals', 'Mean Sq']))
paste("AIC:", poisson1$aic)
...
```{r pre_acc_pois, echo=TRUE, warning=FALSE}
attach(data1)
...
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  ...
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois$lwr[120:126],
              ymax = conf.df_pois$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_pois$fit[1:120]),
              data = data1[1:120, ],
...
attach(data1)
conf.df_pois2 <- predict.confidence(poisson4bis, newdata = data1[1:120, ])
...
paste("RMSE:", sqrt(mean((nb5.pred - data1$`Cumulative cases`[120:126])^2)))
...
```{r nb5bis, echo=TRUE, warning=FALSE}
...
attach(data1)
conf.df_nb <- predict.confidence(nb5, newdata = data1[1:120, ])
...
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_nb$lwr[1:120], ymax = conf.df_nb$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_nb$lwr[120:126], ymax = conf.df_nb$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_nb$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
...
attach(data1)
conf.df_nb2 <- predict.confidence(nb5bis, newdata = data1[1:120, ])
...
<img src="stan_figs/poisson_posterior-1_new.png" alt="poisson_posterior-1_new" style="zoom:40%;" class="center"/>
...
<img src="stan_figs/first_residual-1_new.png" alt="first_residual-1_new" style="zoom:38%;" class="center"/>
...
<img src="stan_figs/NB_posterior-1_new.png" alt="NB_posterior-1_new" style="zoom:40%;" class="center"/>
...
<img src="stan_figs/NB_residuals_new.png" alt="NB_residuals_new.png" style="zoom:60%;" class="center"/>
...
<img src="stan_figs/NB_deps_new.png" alt="NB_deps_new" style="zoom:60%;" class="center"/>
...
<img src="stan_figs/NB2_posterior_new.png" alt="NB2_posterior_new" style="zoom:80%;" class="center"/>
...
<img src="stan_figs/NB2_res_new.png" alt="NB2_res_new" style="zoom:70%;" class="center"/>

## Accuracy across departments

```{r deps_NB2, eval=FALSE, echo=TRUE, warning=FALSE}
ppc_stat_grouped(
  y = model.data2$cases,
  yrep = y_rep,
  group = cases_dep$Department,
...
<img src="stan_figs/hier_posterior_new.png" alt="hier_posterior_new" style="zoom:70%;" class="center"/>
...
<img src="stan_figs/hier_residual_new.png" alt="hier_residual_new" style="zoom:60%;" class="center"/>
...
<img src="stan_figs/hier_deps_new.png" alt="hier_deps_new" style="zoom:60%;" class="center"/>
...
<img src="stan_figs/looic_new.png" alt="looic_new" style="zoom:60%;" class="center"/>