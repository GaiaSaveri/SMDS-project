...
```{r pi_poisson1, echo=TRUE, warning=FALSE}
...
```{r pi_poisson1B, echo=TRUE, warning=FALSE}
...
```{r pi_poisson1C, echo=TRUE, warning=FALSE}
test_cases<-cases[120:126,]
...
test_cases %>% 
  ...
  geom_ribbon(aes(ymin=lpb-(abs(lpb-unname(poisson1C.pred)))-abs(lpb-upb)/2, ymax=upb-(abs(upb-unname(poisson1C.pred)))+abs(upb-lpb)/2), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  ggtitle("Cumulative cases cases 95% PI") +
  xlab("Days") +
  ylab("Total cases")
...
```{r pi_poisson2, echo=TRUE, warning=FALSE}
...
test_data1 %>% 
  ...
  geom_ribbon(aes(ymin=lpb-(abs(lpb-unname(poisson2.pred)))-abs(lpb-upb)/2, ymax=upb-(abs(upb-unname(poisson2.pred)))+abs(upb-lpb)/2), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  ggtitle("Cumulative cases 95% PI") +
  xlab("Days") +
  ylab("Total cases")
...
```{r pi_poisson3, echo=TRUE, warning=FALSE}
...
test_data1 %>% 
  ...
  geom_ribbon(aes(ymin=lpb-(abs(lpb-unname(poisson3.pred)))-abs(lpb-upb)/2, ymax=upb-(abs(upb-unname(poisson3.pred)))+abs(upb-lpb)/2), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  ggtitle("Cumulative cases 95% PI") +
  xlab("Days") +
  ylab("Total cases")
...
```{r pi_poisson4, echo=TRUE, warning=FALSE}
poisson4.pi <- glm(`Cumulative cases` ~ `Elapsed time` + `Grupo de edad_19_30` + `Grupo de edad_31_45` + `Grupo de edad_46_60` + `Grupo de edad_60_75` + `Grupo de edad_76+` + `Departamento o Distrito_Bogotá D.C.` + `Departamento o Distrito_Boyacá` + `Departamento o Distrito_Caldas` + `Departamento o Distrito_Casanare` + `Departamento o Distrito_Cauca` + `Departamento o Distrito_Cundinamarca` + `Departamento o Distrito_Meta` + `Departamento o Distrito_Quindío` + `Departamento o Distrito_Risaralda` + `Departamento o Distrito_Santander` + `Departamento o Distrito_Tolima`, data=test_data1, family=poisson)
test_data1 %>% 
  add_pi(poisson4.pi, names=c("lpb", "upb")) %>%
  ggplot(aes(x=test_cases$`Elapsed time`, y=test_cases$`Cumulative cases`)) +
  geom_point(size=2) +
  geom_point(aes(y=unname(poisson4.pred)), size=2, color="maroon") +
  geom_ribbon(aes(ymin=lpb-(abs(lpb-unname(poisson4.pred)))-abs(lpb-upb)/2, ymax=upb-(abs(upb-unname(poisson4.pred)))+abs(upb-lpb)/2), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  ggtitle("Cumulative cases 95% PI") +
  xlab("Days") +
  ylab("Total cases")
...
n <- 126
freq_coverage_pois4bis <- sum(`New cases/day` >= conf.df_pois4bis[, 64] & `New cases/day` <= conf.df_pois4bis[, 65])
...
```{r pi_poisson1quasi, echo=TRUE, warning=FALSE}
...
```{r pi_nb1, echo=TRUE, warning=FALSE}
...
test_data1 %>% 
  ...
  geom_point(aes(y=unname(nb1.pred)), size=2, color="maroon") +
    geom_ribbon(aes(ymin=lpb+(abs(lpb-unname(nb1.pred)))-abs(lpb-upb)/2, ymax=upb+(abs(upb-unname(nb1.pred)))+abs(upb-lpb)/2), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  ggtitle("Cumulative cases 95% PI") +
  xlab("Days") +
  ylab("Total cases")
```
...
```{r pi_nb2, echo=TRUE, warning=FALSE}
test_data1 %>% 
  add_pi(nb2, names=c("lpb", "upb")) %>%
  ggplot(aes(x=test_data1$`Elapsed time`, y=test_data1$`Cumulative cases`)) +
  geom_point(size=2) +
  geom_point(aes(y=unname(nb2.pred)), size=2, color="maroon") +
    geom_ribbon(aes(ymin=lpb+(abs(lpb-unname(nb2.pred)))-abs(lpb-upb)/2, ymax=upb+(abs(upb-unname(nb2.pred)))+abs(upb-lpb)/2), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  ggtitle("Cumulative cases 95% PI") +
  xlab("Days") +
  ylab("Total cases")
```
...
```{r pi_nb3, echo=TRUE, warning=FALSE}
test_data1 %>% 
...
```{r pi_nb4, echo=TRUE, warning=FALSE}
test_data1 %>% 
...
```{r pi_nb5bis, echo=TRUE, warning=FALSE}
test_data1 %>% 
  ...
  geom_point(aes(y=pred), size=2, color="maroon") +
    geom_ribbon(aes(ymin=lpb, ymax=upb), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  ggtitle("New daily cases cases 95% PI") +
  xlab("Days") +
  ylab("Total cases")
```
...
```{r looic_poisson_cases, eval=FALSE}
...
```{r NB_posterior_cases_ecdf, echo=TRUE, warning=FALSE, eval=FALSE}
