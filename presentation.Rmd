...
quasipoisson2bis.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2", round(quasipoisson2bis.rmse, 2))
quasipoisson3bis.summary<-c("Cumulative cases ~ Elapsed time + Sex", round(quasipoisson3bis.rmse, 2))
quasipoisson4bis.summary<-c("Cumulative cases ~ Elapsed time + Age group", round(quasipoisson4bis.rmse, 2))
quasipoisson5bis.summary<-c("Cumulative cases ~ Elapsed time + Department", round(quasipoisson5bis.rmse, 2))
quasipoisson6bis.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", round(quasipoisson6bis.rmse, 2))
quasipoisson7bis.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", round(quasipoisson7bis.rmse, 2))
...
colnames(gam.cumulative.summary)[1] <- "GAM models for daily cases"
