...
Not necessary also in this case!
...
```{r qpois2bis_pi, echo=FALSE, warning=FALSE}
quasipoisson2bis.pi <- glm(`New cases/day` ~ `Elapsed time` + I(`Elapsed time`^2),
                           data=test_data1, family=quasipoisson)
test_data1 %>%
  add_pi(quasipoisson2bis.pi, names=c("lpb", "upb")) %>%
  ggplot(aes(x=test_data1$`Elapsed time`, y=test_data1$`New cases/day`)) +
  geom_point(size=2) +
  geom_point(aes(y=unname(quasipoisson2bis.pred)), size=2, color="maroon") +
  geom_ribbon(aes(ymin=lpb, ymax=upb), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  coord_cartesian(xlim = c(122, 128)) +
  scale_x_discrete(limit = c(122, 123, 124, 125, 126, 127, 128),
                   labels = c("06-7", "07-7", "08-7", "09-7", "10-7", "11-7", "12-7")) +
...
```{r qpois3bis_pi, echo=FALSE, warning=FALSE}
quasipoisson3bis.pi <- glm(`New cases/day` ~ `Elapsed time` + Sexo_M,
                           data=test_data1, family=quasipoisson)
test_data1 %>%
  add_pi(quasipoisson3bis.pi, names=c("lpb", "upb")) %>%
  ggplot(aes(x=test_data1$`Elapsed time`, y=test_data1$`New cases/day`)) +
  geom_point(size=2) +
  geom_point(aes(y=unname(quasipoisson3bis.pred)), size=2, color="maroon") +
  geom_ribbon(aes(ymin=lpb, ymax=upb), fill = color_scheme_get("red")[[2]], alpha=0.9) +
  coord_cartesian(xlim = c(122, 128)) +
  scale_x_discrete(limit = c(122, 123, 124, 125, 126, 127, 128),
                   labels = c("06-7", "07-7", "08-7", "09-7", "10-7", "11-7", "12-7")) +
