...
poisson6.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", round(poisson6$aic, 2), round(poisson6.rmse, 2))
poisson7.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", round(poisson7$aic, 2), round(poisson7.rmse, 2))
...
nb6.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", round(nb6$aic, 2), round(nb6.rmse, 2))
nb7.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", round(nb7$aic, 2), round(nb7.rmse, 2))
...
nb6bis.summary<-c("New cases/day ~ Elapsed time + Department + Age group", round(nb6bis$aic, 2), round(nb6bis.rmse, 2))
nb7bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2 + Department + Age group", round(nb7bis$aic, 2), round(nb7bis.rmse, 2))
...
gam6.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", round(AIC(gam6), 2), round(gam6.rmse, 2))
gam7.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", round(AIC(gam7), 2), round(gam7.rmse, 2))
