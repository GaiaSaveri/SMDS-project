...
#n=120, k=7, n-k=113
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st5^2)/113))
...
#n=120, k=3, n-k=117
print(paste("Estimated overdispersion", sum(res.st5bis^2)/117))
...
#n=120, k=17, n-k=103
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st6^2)/103))
...
poisson7 <- glm(`Cumulative cases` ~ `Elapsed time` + I(`Elapsed time`^2) +
...
poisson7bis <- glm(`New cases/day` ~ `Elapsed time` + I(`Elapsed time`^2) +
                  `Grupo de edad_19_30` + `Grupo de edad_31_45` + `Grupo de edad_46_60` +
                  `Grupo de edad_60_75` + `Grupo de edad_76+` + `Departamento o Distrito_Bogotá D.C.` +
                  `Departamento o Distrito_Boyacá` + `Departamento o Distrito_Caldas` +
                  `Departamento o Distrito_Casanare` + `Departamento o Distrito_Cauca` +
...
#n=120, k=18, n-k=102
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st7bis^2)/102))
...
poisson.cumulative.summary<-rbind(poisson.cumulative.summary, poisson7.summary)
...
poisson2bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", poisson2bis$aic, poisson2bis.rmse)
poisson3bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", poisson3bis$aic, poisson3bis.rmse)
poisson4bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", poisson4bis$aic, poisson4bis.rmse)
poisson5bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", poisson5bis$aic, poisson5bis.rmse)
poisson6bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", poisson6bis$aic, poisson6bis.rmse)
poisson7bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", poisson7bis$aic, poisson7bis.rmse)
...
#n=120, k= ?, n-k=?
print(paste("Estimated overdispersion", sum(res.stq1^2)/23))
...
#n=120, k=18, n-k=102
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st1bis^2)/102))
...
nb2.summary<-c("Cumulative cases ~ Elapsed time + Age group", nb2$aic, nb2.rmse)
nb3.summary<-c("Cumulative cases ~ Elapsed time + Department", nb3$aic, nb3.rmse)
nb4.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", nb4$aic, nb4.rmse)
...
nb.cases.summary<-data.frame(Model="New cases/day ~ Elapsed time + Age group + Department", AIC = nb4bis$aic, RMSE = nb4bis.rmse)
