...
n <- 126
#freq_coverage_pois1 <- sum(`Cumulative cases` >= conf.df_pois1$lwr & `Cumulative cases` <= conf.df_pois1$upr)
...
ggplot(data1[120:126, ], aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois1$lwr[120:126],
              ymax = conf.df_pois1$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
...
paste("RMSE:", poisson1bis.rmse <- sqrt(mean((poisson1bis.pred - data1$`New cases/day`[120:126])^2)))
...
ggplot(data1[120:126, ], aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois1bis$lwr[120:126],
              ymax = conf.df_pois1bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
...
ggplot(data1[120:126, ], aes(x=`Elapsed time`, y=`Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois3$lwr[120:126],
              ymax = conf.df_pois3$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
...
```{r pois6bis_pi, echo=FALSE, warning=FALSE}
ggplot(data1[120:126, ], aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois6bis$lwr[120:126],
              ymax = conf.df_pois6bis$upr[120:126]),
              data = data1[120:126, ],
...
```{r pois7_pi, echo=FALSE, warning=FALSE}
ggplot(data1[120:126, ], aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois7$lwr[120:126],
              ymax = conf.df_pois7$upr[120:126]),
              data = data1[120:126, ],
...
```{r pois7bis_pi, echo=FALSE, warning=FALSE}
ggplot(data1[120:126, ], aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois7bis$lwr[120:126],
              ymax = conf.df_pois7bis$upr[120:126]),
              data = data1[120:126, ],
...
colnames(poisson.cumulative.summary)[1] <- "Poisson models for cumulative cases"
...
colnames(poisson.cases.summary)[1] <- "Poisson models for daily cases"
...
anova(poisson1, poisson4, poisson6, poisson7, test="Chisq")
```

#### Response variable: New cases/day
```{r Angela11ab, echo=TRUE, warning=FALSE}
anova(poisson1bis, poisson2bis, poisson7bis, test="Chisq")
```
...
pred.qpois2 <- quasipoisson2$fitted.values
res.stq2 <- (data1$`Cumulative cases` - pred.qpois2)/sqrt(summary(quasipoisson2)$dispersion*pred.qpois2)
#n=120, k= 2, n-k=118
print(paste("Estimated overdispersion", sum(res.stq2^2)/118))
...
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  ...
  geom_point(aes(x = `Elapsed time`, y = `Cumulative cases`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="Cumulative cases ~ Elapsed time + Elapsed time^2") +
  xlab("Days") + ylab("Cumulative cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois2bis_fit, echo=TRUE, warning=FALSE, results="hold"}
quasipoisson2bis <- glm(`New cases/day` ~ `Elapsed time` + I(`Elapsed time`^2),
                        data=data1[1:120, ], family=quasipoisson)
```

```{r qpois2bis_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson2bis, which=1)
pred.qpois2bis <- quasipoisson2bis$fitted.values
res.st.qpois2bis <- (data1$`Cumulative cases` - pred.qpois2bis)/sqrt(pred.qpois2bis)
#n=120, k=3, n-k=117
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st.qpois2bis^2)/117))
quasipoisson2bis.pred <- predict(quasipoisson2bis, newdata = data1[120:126, ], type="response")
paste("RMSE:", quasipoisson2bis.rmse <- sqrt(mean((quasipoisson2bis.pred - data1$`New cases/day`[120:126])^2)))
#paste("MSE:", mean(quasipoisson2bis$residuals^2))
#paste("AIC:", quasipoisson2bis$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson2bis$null.deviance, deviance(quasipoisson2bis)), 2))
```
...
```{r qpois2bis_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois2bis <- predict.confidence(quasipoisson2bis, newdata = data1)
#conf.df_qpois2bis <- predict.glm(poisson2bis, newdata = as.data.frame(cbind(data1$`Elapsed time`, data1$`Cumulative cases`)), interval = 'confidence')
n <- 120
freq_coverage_qpois2bis <- sum(`New cases/day` >= conf.df_qpois2bis[, 2] & `New cases/day` <= conf.df_qpois2bis[, 3])
paste("Frequency of coverage:", freq_coverage_qpois2bis <- freq_coverage_qpois2bis/n)
detach(data1)
```

```{r qpois2bis_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois2bis$lwr[1:120],
              ymax = conf.df_qpois2bis$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois2bis$lwr[120:126],
              ymax = conf.df_qpois2bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois2bis$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson2bis.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `New cases/day`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="New cases/day ~ Elapsed time + Elapsed time^2") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois3_fit, echo=TRUE, warning=FALSE, results="hold"}
quasipoisson3 <- glm(`Cumulative cases` ~ `Elapsed time` + Sexo_M,
                     data=data1[1:120, ], family=quasipoisson)
```

```{r qpois3_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson3, which=1)
pred.qpois3 <- quasipoisson3$fitted.values
res.stq3 <- (data1$`Cumulative cases` - pred.qpois3)/sqrt(summary(quasipoisson3)$dispersion*pred.qpois3)
#n=120, k= 2, n-k=118
print(paste("Estimated overdispersion", sum(res.stq3^2)/118))
quasipoisson3.pred <- predict(quasipoisson3, newdata = data1[120:126, ], type = "response")
paste("RMSE:", quasipoisson3.rmse <- sqrt(mean((quasipoisson3.pred - data1$`Cumulative cases`[120:126])^2)))
#paste("MSE:", mean(quasipoisson3$residuals^2))
#paste("AIC:", quasipoisson3$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson3$null.deviance, deviance(quasipoisson3)), 2))
```
...
```{r qpois3_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois3 <- add_pi(data1, quasipoisson3, names=c("lwr","upr"))
n <- 126
freq_coverage_qpois3 <- sum(`Cumulative cases` >= conf.df_qpois3[, 64] & `Cumulative cases` <= conf.df_qpois3[, 65])
paste("Frequency of coverage:", freq_coverage_qpois3 <- freq_coverage_qpois3/n)
detach(data1)
```

```{r qpois3_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois3$lwr[1:120], ymax = conf.df_qpois3$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois3$lwr[120:126],
              ymax = conf.df_qpois3$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois3$pred[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson3.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `Cumulative cases`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="Cumulative cases ~ Elapsed time + Sex") +
  xlab("Days") + ylab("Cumulative cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois3bis_fit, echo=TRUE, warning=FALSE, results="hold"}
quasipoisson3bis <- glm(`New cases/day` ~ `Elapsed time` + Sexo_M,
                        data=data1[1:120, ], family=quasipoisson)
```

```{r qpois3bis_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson3bis, which=1)
pred.qpois3bis <- quasipoisson3bis$fitted.values
res.st.qpois3bis <- (data1$`Cumulative cases` - pred.qpois3bis)/sqrt(pred.qpois3bis)
#n=120, k=3, n-k=117
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st.qpois3bis^2)/117))
quasipoisson3bis.pred <- predict(quasipoisson3bis, newdata = data1[120:126, ], type="response")
paste("RMSE:", quasipoisson3bis.rmse <- sqrt(mean((quasipoisson3bis.pred - data1$`New cases/day`[120:126])^2)))
#paste("MSE:", mean(quasipoisson3bis$residuals^2))
#paste("AIC:", quasipoisson3bis$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson3bis$null.deviance, deviance(quasipoisson3bis)), 2))
```
...
```{r qpois3bis_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois3bis <- predict.confidence(quasipoisson3bis, newdata = data1)
#conf.df_qpois3bis <- predict.glm(poisson3bis, newdata = as.data.frame(cbind(data1$`Elapsed time`, data1$`Cumulative cases`)), interval = 'confidence')
n <- 120
freq_coverage_qpois3bis <- sum(`New cases/day` >= conf.df_qpois3bis[, 2] & `New cases/day` <= conf.df_qpois3bis[, 3])
paste("Frequency of coverage:", freq_coverage_qpois3bis <- freq_coverage_qpois3bis/n)
detach(data1)
```

```{r qpois3bis_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois3bis$lwr[1:120],
              ymax = conf.df_qpois3bis$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois3bis$lwr[120:126],
              ymax = conf.df_qpois3bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois3bis$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson3bis.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `New cases/day`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="New cases/day ~ Elapsed time + Sex") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois4_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois4_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson4, which=1)
pred.poisq4 <- quasipoisson4$fitted.values
res.stq4 <- (data1$`Cumulative cases` - pred.poisq4)/sqrt(summary(quasipoisson4)$dispersion*pred.poisq4)
#n=120, k= 7, n-k=113
print(paste("Estimated overdispersion", sum(res.stq4^2)/113))
quasipoisson4.pred <- predict(quasipoisson4, newdata = data1[120:126, ], type = "response")
paste("RMSE:", quasipoisson4.rmse <- sqrt(mean((quasipoisson4.pred - data1$`Cumulative cases`[120:126])^2)))
#paste("MSE:", mean(quasipoisson4$residuals^2))
#paste("AIC:", quasipoisson4$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson4$null.deviance, deviance(quasipoisson4)), 2))
```
...
```{r qpois4_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois4 <- add_pi(data1, quasipoisson4, names=c("lwr", "upr"))
n <- 126
freq_coverage_qpois2 <- sum(`Cumulative cases` >= conf.df_qpois4[, 64] & `Cumulative cases` <= conf.df_qpois4[, 65])
paste("Frequency of coverage:", freq_coverage_qpois2 <- freq_coverage_qpois2/n)
detach(data1)
```

```{r qpois4_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois4$lwr[1:120], ymax = conf.df_qpois4$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois4$lwr[120:126],
              ymax = conf.df_qpois4$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois4$pred[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson4.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `Cumulative cases`)) +
...
```{r qpois4bis_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois4bis_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson4bis, which=1)
pred.qpois4bis <- quasipoisson4bis$fitted.values
res.st.qpois4bis <- (data1$`Cumulative cases` - pred.qpois4bis)/sqrt(pred.qpois4bis)
#n=120, k=7, n-k=113
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st.qpois4bis^2)/113))
quasipoisson4bis.pred <- predict(quasipoisson4bis, newdata = data1[120:126, ], type="response")
paste("RMSE:", quasipoisson4bis.rmse <- sqrt(mean((quasipoisson4bis.pred - data1$`New cases/day`[120:126])^2)))
#paste("MSE:", mean(quasipoisson4bis$residuals^2))
#paste("AIC:", quasipoisson4bis$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson4bis$null.deviance, deviance(quasipoisson4bis)), 2))
```
...
```{r qpois4bis_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois4bis <- predict.confidence(quasipoisson4bis, newdata = data1)
#conf.df_qpois4bis <- predict.glm(poisson4bis, newdata = as.data.frame(cbind(data1$`Elapsed time`, data1$`Cumulative cases`)), interval = 'confidence')
n <- 120
freq_coverage_qpois4bis <- sum(`New cases/day` >= conf.df_qpois4bis[, 2] & `New cases/day` <= conf.df_qpois4bis[, 3])
paste("Frequency of coverage:", freq_coverage_qpois4bis <- freq_coverage_qpois4bis/n)
detach(data1)
```

```{r qpois4bis_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois4bis$lwr[1:120],
              ymax = conf.df_qpois4bis$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois4bis$lwr[120:126],
              ymax = conf.df_qpois4bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois4bis$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson4bis.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `New cases/day`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="New cases/day ~ Elapsed time + Age group") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois5_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois5_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson5, which=1)
pred.qpois5 <- quasipoisson5$fitted.values
res.stq5 <- (data1$`Cumulative cases` - pred.qpois5)/sqrt(summary(quasipoisson5)$dispersion*pred.qpois5)
#n=120, k= 2, n-k=118
print(paste("Estimated overdispersion", sum(res.stq5^2)/118))
quasipoisson5.pred <- predict(quasipoisson5, newdata = data1[120:126, ], type = "response")
paste("RMSE:", quasipoisson5.rmse <- sqrt(mean((quasipoisson5.pred - data1$`Cumulative cases`[120:126])^2)))
#paste("MSE:", mean(quasipoisson5$residuals^2))
#paste("AIC:", quasipoisson5$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson5$null.deviance, deviance(quasipoisson5)), 2))
```
...
```{r qpois5_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois5 <- add_pi(data1, quasipoisson5, names=c("lwr","upr"))
n <- 126
freq_coverage_qpois5 <- sum(`Cumulative cases` >= conf.df_qpois5[, 64] & `Cumulative cases` <= conf.df_qpois5[, 65])
paste("Frequency of coverage:", freq_coverage_qpois5 <- freq_coverage_qpois5/n)
detach(data1)
```

```{r qpois5_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois5$lwr[1:120], ymax = conf.df_qpois5$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois5$lwr[120:126],
              ymax = conf.df_qpois5$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois5$pred[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson5.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `Cumulative cases`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="Cumulative cases ~ Elapsed time + Department") +
  xlab("Days") + ylab("Cumulative cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois5bis_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois5bis_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson5bis, which=1)
pred.qpois5bis <- quasipoisson5bis$fitted.values
res.st.qpois5bis <- (data1$`Cumulative cases` - pred.qpois5bis)/sqrt(pred.qpois5bis)
#n=120, k=13, n-k=107
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st.qpois5bis^2)/107))
quasipoisson5bis.pred <- predict(quasipoisson5bis, newdata = data1[120:126, ], type="response")
paste("RMSE:", quasipoisson5bis.rmse <- sqrt(mean((quasipoisson5bis.pred - data1$`New cases/day`[120:126])^2)))
#paste("MSE:", mean(quasipoisson5bis$residuals^2))
#paste("AIC:", quasipoisson5bis$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson5bis$null.deviance, deviance(quasipoisson5bis)), 2))
```
...
```{r qpois5bis_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois5bis <- predict.confidence(quasipoisson5bis, newdata = data1)
#conf.df_qpois5bis <- predict.glm(poisson5bis, newdata = as.data.frame(cbind(data1$`Elapsed time`, data1$`Cumulative cases`)), interval = 'confidence')
n <- 120
freq_coverage_qpois5bis <- sum(`New cases/day` >= conf.df_qpois5bis[, 2] & `New cases/day` <= conf.df_qpois5bis[, 3])
paste("Frequency of coverage:", freq_coverage_qpois5bis <- freq_coverage_qpois5bis/n)
detach(data1)
```

```{r qpois5bis_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois5bis$lwr[1:120],
              ymax = conf.df_qpois5bis$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois5bis$lwr[120:126],
              ymax = conf.df_qpois5bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois5bis$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson5bis.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `New cases/day`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="New cases/day ~ Elapsed time + Department") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois6_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois6_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson6, which=1)
pred.qpois6 <- quasipoisson6$fitted.values
res.stq6 <- (data1$`Cumulative cases` - pred.qpois6)/sqrt(summary(quasipoisson6)$dispersion*pred.qpois6)
#n=120, k= 2, n-k=118
print(paste("Estimated overdispersion", sum(res.stq6^2)/118))
quasipoisson6.pred <- predict(quasipoisson6, newdata = data1[120:126, ], type = "response")
paste("RMSE:", quasipoisson6.rmse <- sqrt(mean((quasipoisson6.pred - data1$`Cumulative cases`[120:126])^2)))
#paste("MSE:", mean(quasipoisson6$residuals^2))
#paste("AIC:", quasipoisson6$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson6$null.deviance, deviance(quasipoisson6)), 2))
```
...
```{r qpois6_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois6 <- add_pi(data1, quasipoisson6, names=c("lwr","upr"))
n <- 126
freq_coverage_qpois6 <- sum(`Cumulative cases` >= conf.df_qpois6[, 64] & `Cumulative cases` <= conf.df_qpois6[, 65])
paste("Frequency of coverage:", freq_coverage_qpois6 <- freq_coverage_qpois6/n)
detach(data1)
```

```{r qpois6_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois6$lwr[1:120], ymax = conf.df_qpois6$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois6$lwr[120:126],
              ymax = conf.df_qpois6$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois6$pred[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson6.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `Cumulative cases`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="Cumulative cases ~ Elapsed time + Age group + Department") +
  xlab("Days") + ylab("Cumulative cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois6bis_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois6bis_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson6bis, which=1)
pred.qpois6bis <- quasipoisson6bis$fitted.values
res.st.qpois6bis <- (data1$`Cumulative cases` - pred.qpois6bis)/sqrt(pred.qpois6bis)
#n=120, k=18, n-k=102
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st.qpois6bis^2)/102))
quasipoisson6bis.pred <- predict(quasipoisson6bis, newdata = data1[120:126, ], type="response")
paste("RMSE:", quasipoisson6bis.rmse <- sqrt(mean((quasipoisson6bis.pred - data1$`New cases/day`[120:126])^2)))
#paste("MSE:", mean(quasipoisson6bis$residuals^2))
#paste("AIC:", quasipoisson6bis$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson6bis$null.deviance, deviance(quasipoisson6bis)), 2))
```
...
```{r qpois6bis_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois6bis <- predict.confidence(quasipoisson6bis, newdata = data1)
#conf.df_qpois6bis <- predict.glm(poisson6bis, newdata = as.data.frame(cbind(data1$`Elapsed time`, data1$`Cumulative cases`)), interval = 'confidence')
n <- 120
freq_coverage_qpois6bis <- sum(`New cases/day` >= conf.df_qpois6bis[, 2] & `New cases/day` <= conf.df_qpois6bis[, 3])
paste("Frequency of coverage:", freq_coverage_qpois6bis <- freq_coverage_qpois6bis/n)
detach(data1)
```

```{r qpois6bis_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois6bis$lwr[1:120],
              ymax = conf.df_qpois6bis$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois6bis$lwr[120:126],
              ymax = conf.df_qpois6bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois6bis$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson6bis.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `New cases/day`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="New cases/day ~ Elapsed time + Age group + Department") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois7_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois7_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson7, which=1)
pred.qpois7 <- quasipoisson7$fitted.values
res.stq7 <- (data1$`Cumulative cases` - pred.qpois7)/sqrt(summary(quasipoisson7)$dispersion*pred.qpois7)
#n=120, k= 2, n-k=118
print(paste("Estimated overdispersion", sum(res.stq7^2)/118))
quasipoisson7.pred <- predict(quasipoisson7, newdata = data1[120:126, ], type = "response")
paste("RMSE:", quasipoisson7.rmse <- sqrt(mean((quasipoisson7.pred - data1$`Cumulative cases`[120:126])^2)))
#paste("MSE:", mean(quasipoisson7$residuals^2))
#paste("AIC:", quasipoisson7$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson7$null.deviance, deviance(quasipoisson7)), 2))
```
...
```{r qpois7_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois7 <- add_pi(data1, quasipoisson7, names=c("lwr","upr"))
n <- 126
freq_coverage_qpois7 <- sum(`Cumulative cases` >= conf.df_qpois7[, 64] & `Cumulative cases` <= conf.df_qpois7[, 65])
paste("Frequency of coverage:", freq_coverage_qpois7 <- freq_coverage_qpois7/n)
detach(data1)
```

```{r qpois7_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `Cumulative cases`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois7$lwr[1:120], ymax = conf.df_qpois7$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois7$lwr[120:126],
              ymax = conf.df_qpois7$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois7$pred[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson7.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `Cumulative cases`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="Cumulative cases ~ Elapsed time + Elapsed time^2 + Age group + Department") +
  xlab("Days") + ylab("Cumulative cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
```{r qpois7bis_fit, echo=TRUE, warning=FALSE, results="hold"}
...
```{r qpois7bis_index, echo=FALSE, warning=FALSE, results="hold"}
plot(quasipoisson7bis, which=1)
pred.qpois7bis <- quasipoisson7bis$fitted.values
res.st.qpois7bis <- (data1$`Cumulative cases` - pred.qpois7bis)/sqrt(pred.qpois7bis)
#n=120, k=19, n-k=101
print(paste("Estimated overdispersion", est.overdispersion <- sum(res.st.qpois7bis^2)/101))
quasipoisson7bis.pred <- predict(quasipoisson7bis, newdata = data1[120:126, ], type="response")
paste("RMSE:", quasipoisson7bis.rmse <- sqrt(mean((quasipoisson7bis.pred - data1$`New cases/day`[120:126])^2)))
#paste("MSE:", mean(quasipoisson7bis$residuals^2))
#paste("AIC:", quasipoisson7bis$aic)
paste(c("Null deviance: ", "Residual deviance:"),
       round(c(quasipoisson7bis$null.deviance, deviance(quasipoisson7bis)), 2))
```
...
```{r qpois7bis_pred_acc, echo=FALSE, warning=FALSE}
attach(data1)
conf.df_qpois7bis <- predict.confidence(quasipoisson7bis, newdata = data1)
#conf.df_qpois7bis <- predict.glm(poisson7bis, newdata = as.data.frame(cbind(data1$`Elapsed time`, data1$`Cumulative cases`)), interval = 'confidence')
n <- 120
freq_coverage_qpois7bis <- sum(`New cases/day` >= conf.df_qpois7bis[, 2] & `New cases/day` <= conf.df_qpois7bis[, 3])
paste("Frequency of coverage:", freq_coverage_qpois7bis <- freq_coverage_qpois7bis/n)
detach(data1)
```

```{r qpois7bis_pred_acc_plot, echo=FALSE, warning=FALSE}
ggplot(data1, aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois7bis$lwr[1:120],
              ymax = conf.df_qpois7bis$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_qpois7bis$lwr[120:126],
              ymax = conf.df_qpois7bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_qpois7bis$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
  geom_line(aes(x= `Elapsed time`, y = quasipoisson7bis.pred),
              data = data1[120:126, ],
              color = color_scheme_get("red")[[4]],
              size = 1.1) +
  geom_point(aes(x = `Elapsed time`, y = `New cases/day`)) +
  expand_limits(x = 130) +
  ggtitle("Quasi Poisson regression", subtitle="New cases/day ~ Elapsed time + Elapsed time^2 + Age group + Department") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap('reg', scales ='free') +
...
quasipoisson2.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2", round(quasipoisson2.rmse, 2))
quasipoisson3.summary<-c("Cumulative cases ~ Elapsed time + Sex", round(quasipoisson3.rmse, 2))
quasipoisson4.summary<-c("Cumulative cases ~ Elapsed time + Age group", round(quasipoisson4.rmse, 2))
quasipoisson5.summary<-c("Cumulative cases ~ Elapsed time + Department", round(quasipoisson5.rmse, 2))
quasipoisson6.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", round(quasipoisson6.rmse, 2))
quasipoisson7.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", round(quasipoisson7.rmse, 2))

quasipoisson.cumulative.summary$Model<-as.character(quasipoisson.cumulative.summary$Model)
colnames(quasipoisson.cumulative.summary)[1] <- "Quasi Poisson models for cumulative cases"
quasipoisson.cumulative.summary<-rbind(quasipoisson.cumulative.summary, quasipoisson2.summary, quasipoisson3.summary, quasipoisson4.summary, quasipoisson5.summary, quasipoisson6.summary, quasipoisson7.summary)
...
quasipoisson2bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2", round(quasipoisson2bis.rmse, 2))
quasipoisson3bis.summary<-c("New cases/day ~ Elapsed time + Sex", round(quasipoisson3bis.rmse, 2))
quasipoisson4bis.summary<-c("New cases/day ~ Elapsed time + Age group", round(quasipoisson4bis.rmse, 2))
quasipoisson5bis.summary<-c("New cases/day ~ Elapsed time + Department", round(quasipoisson5bis.rmse, 2))
quasipoisson6bis.summary<-c("New cases/day ~ Elapsed time + Department + Age group", round(quasipoisson6bis.rmse, 2))
quasipoisson7bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2 + Department + Age group", round(quasipoisson7bis.rmse, 2))

quasipoisson.cases.summary$Model<-as.character(quasipoisson.cases.summary$Model)
colnames(quasipoisson.cases.summary)[1] <- "Quasi Poisson models for daily cases"
quasipoisson.cases.summary<-rbind(quasipoisson.cases.summary, quasipoisson2bis.summary, quasipoisson3bis.summary, quasipoisson4bis.summary, quasipoisson5bis.summary, quasipoisson6bis.summary, quasipoisson7bis.summary)
...
colnames(nb.cumulative.summary)[1] <- "Negative Binomial models for cumulative cases"
...
nb.cases.summary<-data.frame(Model="New cases/day ~ Elapsed time", AIC = round(nb1bis$aic, 2), RMSE = round(nb1bis.rmse, 2))
...
colnames(nb.cases.summary)[1] <- "Negative Binomial models for daily cases"
...
#### Response variable: New cases/day
```{r anova_nba, echo=TRUE, warning=FALSE}
...
ggplot(df[120:126, ], aes(Elapsed_time, Cumulative_cases)) +
  geom_ribbon(aes(x = Elapsed_time, ymin = test.lwr.gam1, ymax = test.upr.gam1),
              data = df[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x= Elapsed_time, y = gam1.pred),
...
gam3bis <- gam(New_cases_day ~ s(Elapsed_time) + s(Sexo_M),
               family = poisson(), data = df[1:120,])
```
...
ggplot(df, aes(Elapsed_time, New_cases_day)) +
  ...
  geom_point(aes(x = Elapsed_time, y = New_cases_day)) +
  expand_limits(x = 130) +
  ggtitle("GAM Model", subtitle="New cases/day ~ Elapsed time + Sex + Age group") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap(~"Department", scales ='free') +
...
gam.check(gam5, old.style=TRUE, select=2)
...
```{r gam5_pred_acc_plot, echo=FALSE, warning=FALSE, results="hold"}
ggplot(df, aes(Elapsed_time, Cumulative_cases)) +
...
gam.check(gam5bis, old.style=TRUE, select=2)
...
```{r gam5bis_pred_acc_plot, echo=FALSE, warning=FALSE, results="hold"}
ggplot(df, aes(Elapsed_time, New_cases_day)) +
  ...
  geom_point(aes(x = Elapsed_time, y = New_cases_day)) +
  expand_limits(x = 129) +
  ggtitle("GAM Model", subtitle="New cases/day ~ Elapsed time + Sex + Department") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap(~"Department", scales ='free') +
...
gam6bis <- gam(New_cases_day ~ s(Elapsed_time) + s(Sexo_M) + Grupo_de_edad_19_30 +
...
ggplot(df, aes(Elapsed_time, New_cases_day)) +
  ...
  geom_point(aes(x = Elapsed_time, y = New_cases_day)) +
  expand_limits(x = 130) +
  ggtitle("GAM Model", subtitle="New cases/day ~ Elapsed time + Sex + Age group + Department") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap(~"Department", scales ='free') +
...
ggplot(df, aes(Elapsed_time, New_cases_day)) +
  ...
  geom_point(aes(x = Elapsed_time, y = New_cases_day)) +
  expand_limits(x = 130) +
  ggtitle("GAM Model", subtitle="New cases/day ~ Elapsed time + Elapsed time^2 + Sex +  Age group + Department") +
  xlab("Days") + ylab("Daily cases") +
  scale_x_discrete(limit = c(0, 21, 42, 63, 84, 105, 122, 128),
                labels = c("06-3", "29-3", "19-4", "10-5", "31-5", "21-6", "06-7", "12-7")) +
  # facet_wrap(~"Department", scales ='free') +
...
gam.cumulative.summary<-data.frame(Model="Cumulative cases ~ s(Elapsed time)", AIC = round(AIC(gam1), 2), RMSE = round(gam1.rmse, 2))
gam2.summary<-c("Cumulative cases ~ s(Elapsed time) + s(Elapsed time)
                ^2)", round(AIC(gam2), 2), round(gam2.rmse, 2))
gam3.summary<-c("Cumulative cases ~ s(Elapsed time) + s(Sex)", round(AIC(gam3), 2), round(gam3.rmse, 2))
gam4.summary<-c("Cumulative cases ~ s(Elapsed time) + Age group", round(AIC(gam4), 2), round(gam4.rmse, 2))
gam5.summary<-c("Cumulative cases ~ s(Elapsed time) + Department", round(AIC(gam5), 2), round(gam5.rmse, 2))
gam6.summary<-c("Cumulative cases ~ s(Elapsed time) + Age group + Department", round(AIC(gam6), 2), round(gam6.rmse, 2))
gam7.summary<-c("Cumulative cases ~ s(Elapsed time) + s(Elapsed time^2) + Age group + Department", round(AIC(gam7), 2), round(gam7.rmse, 2))

gam.cumulative.summary$Model<-as.character(gam.cumulative.summary$Model)
colnames(gam.cumulative.summary)[1] <- "GAM models for cumulative cases"
...
gam.cases.summary<-data.frame(Model="New cases/day ~ s(Elapsed time)", AIC = round(AIC(gam1bis), 2), RMSE = round(gam1bis.rmse, 2))
gam2bis.summary<-c("New cases/day ~ s(Elapsed time) + s(Elapsed time^2)", round(AIC(gam2bis), 2), round(gam2bis.rmse, 2))
gam3bis.summary<-c("New cases/day ~ s(Elapsed time) + s(Sex)", round(AIC(gam3bis), 2), round(gam3bis.rmse, 2))
gam4bis.summary<-c("New cases/day ~ s(Elapsed time) + s(Sex) + Age group", round(AIC(gam4bis), 2), round(gam4bis.rmse, 2))
gam5bis.summary<-c("New cases/day ~ s(Elapsed time) + s(Sex) + Department", round(AIC(gam5bis), 2), round(gam5bis.rmse, 2))
gam6bis.summary<-c("New cases/day ~ s(Elapsed time) + s(Sex) + Age group + Department", round(AIC(gam6bis), 2), round(gam6bis.rmse, 2))
gam7bis.summary<-c("New cases/day ~ s(Elapsed time) + s(Elapsed time^2) + s(Sex) + Age group + Department", round(AIC(gam7bis), 2), round(gam7bis.rmse, 2))

gam.cases.summary$Model<-as.character(gam.cases.summary$Model)
colnames(gam.cases.summary)[1] <- "GAM models for daily cases"
...
#### Response variable: Cumulative cases
```{r ANOVAgam, echo=TRUE, warning=FALSE}
anova(gam1, gam5, gam6, gam7, test="Chisq")
```

#### Response variable: New cases/day
```{r ANOVAgam2, echo=TRUE, warning=FALSE}
anova(gam1bis,gam5bis, gam6bis, gam7bis, test="Chisq")
```
...
```{r save/load, include=FALSE}
#setwd("/home/angela/Documenti/Statistical Methods for Data Science/Project/SMDS-project/")
