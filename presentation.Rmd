...
poisson.cumulative.summary<-data.frame(Model="Cumulative cases ~ Elapsed time", AIC = poisson1$aic, RMSE = poisson1.rmse)
poisson2.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2", poisson2$aic, poisson2.rmse)
poisson3.summary<-c("Cumulative cases ~ Elapsed time + Sex", poisson3$aic, poisson3.rmse)
poisson4.summary<-c("Cumulative cases ~ Elapsed time + Age group", poisson4$aic, poisson4.rmse)
poisson5.summary<-c("Cumulative cases ~ Elapsed time + Department", poisson5$aic, poisson5.rmse)
poisson6.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", poisson6$aic, poisson6.rmse)
poisson7.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", poisson7$aic, poisson7.rmse)
...
poisson.cases.summary<-data.frame(Model="New cases/day ~ Elapsed time", AIC = poisson1bis$aic, RMSE = poisson1bis.rmse)
poisson2bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2", poisson2bis$aic, poisson2bis.rmse)
poisson3bis.summary<-c("New cases/day ~ Elapsed time + Sex", poisson3bis$aic, poisson3bis.rmse)
poisson4bis.summary<-c("New cases/day ~ Elapsed time + Age group", poisson4bis$aic, poisson4bis.rmse)
poisson5bis.summary<-c("New cases/day ~ Elapsed time + Department", poisson5bis$aic, poisson5bis.rmse)
poisson6bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", poisson6bis$aic, poisson6bis.rmse)
poisson7bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2 + Age group + Department", poisson7bis$aic, poisson7bis.rmse)
...
attach(data1)
conf.df_pois1bis <- predict.confidence(quasipoisson1bis, newdata = data1)
...
n <- 120
freq_coverage_pois1bis <- sum(`New cases/day` >= conf.df_pois1bis[, 2] & `New cases/day` <= conf.df_pois1bis[, 3])
paste("Frequency of coverage:", freq_coverage_pois1bis <- freq_coverage_pois1bis/n)
detach(data1)
```
...
ggplot(data1, aes(`Elapsed time`, `New cases/day`)) +
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois1bis$lwr[1:120],
              ymax = conf.df_pois1bis$upr[1:120]),
              data = data1[1:120, ],
              fill = color_scheme_get("blue")[[2]]) + 
  geom_ribbon(aes(x = `Elapsed time`, ymin = conf.df_pois1bis$lwr[120:126],
              ymax = conf.df_pois1bis$upr[120:126]),
              data = data1[120:126, ],
              fill = color_scheme_get("red")[[2]]) +
  geom_line(aes(x = `Elapsed time`, y = conf.df_pois1bis$fit[1:120]),
              data = data1[1:120, ],
              color = color_scheme_get("blue")[[4]], 
              size = 1.1) +
...
quasipoisson.cumulative.summary<-data.frame(Model="Cumulative cases ~ Elapsed time", RMSE = quasipoisson1.rmse)
quasipoisson2.summary<-c("Cumulative cases ~ Elapsed time + Age group", quasipoisson2.rmse)
...
quasipoisson.cases.summary<-data.frame(Model="New cases/day ~ Elapsed time", RMSE = quasipoisson1bis.rmse)
...
### Negative Binomial with `Elapsed time`, `Elapsed time`^2, `Age` and `Departments` as pedictors
...
### Negative Binomial with `Elapsed time`, `Elapsed time`^2, `Age` and `Departments` as pedictors for `New cases/day`
...
nb.cumulative.summary<-data.frame(Model="Cumulative cases ~ Elapsed time", AIC = nb1$aic, RMSE = nb1.rmse)
nb2.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2", nb2$aic, nb2.rmse)
nb3.summary<-c("Cumulative cases ~ Elapsed time + Sex", nb3$aic, nb3.rmse)
nb4.summary<-c("Cumulative cases ~ Elapsed time + Age group", nb4$aic, nb4.rmse)
nb5.summary<-c("Cumulative cases ~ Elapsed time + Department", nb5$aic, nb5.rmse)
nb6.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", nb6$aic, nb6.rmse)
nb7.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", nb7$aic, nb7.rmse)
...
nb.cases.summary<-data.frame(Model="New cases/day ~ Elapsed time + Age group + Department", AIC = nb1bis$aic, RMSE = nb1bis.rmse)
nb2bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2", nb2bis$aic, nb2bis.rmse)
nb3bis.summary<-c("New cases/day ~ Elapsed time + Sex", nb3bis$aic, nb3bis.rmse)
nb4bis.summary<-c("New cases/day ~ Elapsed time + Age group", nb4bis$aic, nb4bis.rmse)
nb5bis.summary<-c("New cases/day ~ Elapsed time + Department", nb5bis$aic, nb5bis.rmse)
nb6bis.summary<-c("New cases/day ~ Elapsed time + Department + Age group", nb6bis$aic, nb6bis.rmse)
nb7bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2 + Department + Age group", nb7bis$aic, nb7bis.rmse)
...
gam2 <- gam(Cumulative_cases ~ s(Elapsed_time) + s(I(Elapsed_time^2)),
             family = poisson, data = df[1:120,])
```
...
### Gam with `Elapsed time`, `Age group` and `Department` as covariate for `New cases/day`

```{r gam6bis_fit, echo=TRUE, warning=FALSE, results="hold"}
...
gam.cumulative.summary<-data.frame(Model="Cumulative cases ~ Elapsed time", AIC = AIC(gam1), RMSE = gam1.rmse)
gam2.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2", AIC(gam2), gam2.rmse)
gam3.summary<-c("Cumulative cases ~ Elapsed time + Sex", AIC(gam3), gam3.rmse)
gam4.summary<-c("Cumulative cases ~ Elapsed time + Age group", AIC(gam4), gam4.rmse)
gam5.summary<-c("Cumulative cases ~ Elapsed time + Department", AIC(gam5), gam5.rmse)
gam6.summary<-c("Cumulative cases ~ Elapsed time + Department + Age group", AIC(gam6), gam6.rmse)
gam7.summary<-c("Cumulative cases ~ Elapsed time + Elapsed time^2 + Department + Age group", AIC(gam7), gam7.rmse)
...
#gam.cases.summary<-data.frame(Model="New cases/day ~ Elapsed time", AIC = AIC(gam1bis), RMSE = gam1bis.rmse)
#gam2bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2", AIC(gam2bis), gam2bis.rmse)
#gam3bis.summary<-c("New cases/day ~ Elapsed time + Sex", AIC(gam3bis), gam3bis.rmse)
#gam4bis.summary<-c("New cases/day ~ Elapsed time + Age group", AIC(gam4bis), gam4bis.rmse)
#gam5bis.summary<-c("New cases/day ~ Elapsed time + Department", AIC(gam5bis), gam5bis.rmse)
#gam6bis.summary<-c("New cases/day ~ Elapsed time + Age group + Department", AIC(gam6bis), gam6bis.rmse)
#gam7bis.summary<-c("New cases/day ~ Elapsed time + Elapsed time^2 + Age group + Department", AIC(gam7bis), gam7bis.rmse)
